...
describe('basic', function () {
  ...
  describe('jsdom tests', function () {
    ...
    var Comp = void 0;
    var WrapperComp = void 0;
    var wrapper = void 0;

    beforeEach(function () {
      Comp = styled.div(_templateObject);
      WrapperComp = function (_Component) {
      ...
      wrapper = (0, _enzyme.mount)(_react2.default.createElement(WrapperComp, null));
    });
    ...
    it('should not pass innerRef to the component', function () {
      // $FlowIssue
